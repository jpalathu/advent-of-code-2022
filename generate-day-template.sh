...
fn main() -> Result<(), Box<dyn Error>> {
    let answer = puzzle_1_solution("./input/puzzle-input.txt")?;
    println!("Puzzle 1 solution: {}", answer);
    let answer = puzzle_2_solution("./input/puzzle-input.txt")?;
    println!("Puzzle 2 solution: {}", answer);
    Ok(())
}
EOF
